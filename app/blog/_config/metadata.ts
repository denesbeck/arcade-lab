...
const BLOG_METADATA: BlogMeta[] = [
  {
    ...
    file: 'self-hosted-developer-platform-on-k8s-p4',
  },
  {
    id: 40,
    slug: 'grpc-jwt-roles-and-streaming',
    title: 'gRPC: The Interceptor That Never Ran',
    description:
      'Adding JWTs, per-method roles and all four streaming shapes - and the stream interceptor whose absence protected nothing, silently',
    date: '2026-08-22',
    hidden: false,
    tags: [
      'grpc',
  ...
  {
    id: 39,
    slug: 'grpc-whats-actually-on-the-wire',
    title: "gRPC: What's Actually on the Wire",
    description:
      'What gRPC actually is, learned by building the smallest possible service in Go and then putting TLS and a bearer token in front of it',
    date: '2026-08-21',
    hidden: false,
    tags: [
      'grpc',
