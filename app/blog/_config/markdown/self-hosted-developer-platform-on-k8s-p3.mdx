...
[Part 2](/blog/cilium-ebpf-on-talos) ended with a quiet, correct foundation: encrypted secrets, CI gates, and Cilium doing the networking. Nothing on the cluster yet that needs to reach out of it.
