...
Back in October 2025, I wrote about [automating Lambda deployments with GitHub Actions](/blog/lambda-deployments-github-actions-oidc). That workflow was functional — it deployed Lambda functions and layers across multiple regions using hash-based change detection and OIDC authentication. But as I started relying on it more heavily, cracks began to show.
