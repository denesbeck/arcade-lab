...
const About = () => {
  return (
    <div className="flex flex-col justify-center items-center w-dvw">
      ...
      <div className="flex flex-col py-4 px-2 transition-all duration-200 ease-in-out sm:w-max sm:ring-2 lg:py-8 lg:px-8 lg:mt-0 ring-secondary animate-slide-in-from-bottom max-h-[calc(100dvh-200px)] backdrop-blur-md sm:max-w-[90dvw] sm:hover:shadow-[10px_10px_#46ecd5,20px_20px_black]">
