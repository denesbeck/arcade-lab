...
- **About** -- Bio, skills (19 technologies), certificates (AWS Developer Associate, AWS CloudOps Associate, Terraform Associate), and social links
- **Blog** -- 30 MDX-based technical posts covering topics like building a home server, developing a custom VCS in Go, CloudGoat ethical hacking write-ups, CI/CD pipelines, and AWS Lambda deployments. Supports tag-based filtering.
